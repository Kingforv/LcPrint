...
public class LabelPicActivity extends BaseActivity implements View.OnClickListener, PrinterBinderListener {
            ...
            case R.id.btn_pic_print:
                ...
                try {
                    ...
                    if (mBitmap != null) {
                        ...
                        printUtil.addImage(PrintConfig.Align.ALIGN_CENTER, BlackWhiteBitmap);

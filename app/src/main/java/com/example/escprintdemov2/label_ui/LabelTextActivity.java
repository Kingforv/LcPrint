...
public class LabelTextActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener, PrinterBinderListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_print_text:
                ...
                printUtil.addText(align_mode, mode_enlarge, bold, underline,strContent);
